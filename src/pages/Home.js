...
export default function Home() {
  return (
    <div>
      <section className="headSection pt-4 pt-md-11">
      ...
      <section className="brands">
        <div className="row mx-0">
          <div className="col-sm-12 col-md-6 col-lg-6 pr-5 pl-0">
            <div className="header font-35">Brands that trust us...</div>
            <p className="subheader py-3 font-18">
      ...
      <section id="product" className="sectionPadding">
        <div className=" ">
          ...
          <div className="header font-35">The Impact of SeerBit.</div>
        </div>
